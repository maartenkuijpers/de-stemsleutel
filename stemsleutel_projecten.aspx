...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="contentMain">
    ...
    <h3>Projecten</h3>
    <ul>
        <li><strong>ER ZIT ALTIJD WEL EEN LIEDJE IN JE - Zingen voor Basisschoolleerlingen.</strong><br />
            Bij voldoende deelname zal er op maandag 15 september bovengenoemd projekt starten in de Pracht te Aalst-Waalre. <a target="_blank" href="pdf/Projekt Zingen voor basisschool 2014-2015.pdf">
